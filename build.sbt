...
lazy val commonSettings = Seq(
  ...
  Test / coverageMinimumStmtTotal := 40,
  fork := true
)
...
lazy val `backend-sample` =
  (project in file("backend-sample"))
    .settings(commonSettings ++ backendSampleSettings)
    .settings(
      Compile / mainClass := Some("ru.tinkoff.backendacademy.petapp.App"),
